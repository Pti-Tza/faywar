...
export class DocumentationModule {
    ...
    docsCachePath;
    debugMode;
    constructor(godotPath, cacheDir, debugMode = false) {
     ...
     */
    async parseClassXML(xmlContent, className) {
        try {
     ...
     */
    async getMethodInfo(className, methodName) {
